...
<body style="color: #332D2B">
            ...
            <div class="container-fluid h w-100 py-5">
                <div class="row ">
                    <div class="col-md-6 col1 position-relative  ">
                        ...
                        <small>Para que las funciones y desafíos sean divertidos y hacen que el aprendizaje se sienta como un juego.</small>
                        <hr>
                    </div>
            ...
            <section>
                ...
                <div class="container--contacto">
                    <form class="contact-form">
                        <input type="text" name="name" placeholder="Escribe tu nombre" style="width: 100%; " title="Nombre sólo acepta letras y espacios en blanco" required>
                        <input type="email" name="email" placeholder="Escribe tu email" title="Email incorrecto" style="width: 100%;" required>
                        <input type="text" name="subject" placeholder="Asunto a tratar" title="El Asunto es requerido" style="width: 100%;" required>
                        <textarea name="comments" cols="50" rows="5" placeholder="Escribe tus comentarios" title="Tu comentario no debe exceder los 255 caracteres" required></textarea>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" type="module" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous">
    </script>
</body>
