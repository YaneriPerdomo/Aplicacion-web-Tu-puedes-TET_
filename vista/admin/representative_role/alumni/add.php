...
<head>
    ...
    <title>Tu puedes | Agrega tu usuario</title>
...
<body>
    ...
    <main>
        <div class="contianerAdmin" style=" max-width: 700px; min-width: 100px;">
            ...
            <hr>
            <p>Introduce los siguientes datos para crear un nuevo usuario.  favor, asegúrate de la veracidad de los datos introducidos.  </p>
