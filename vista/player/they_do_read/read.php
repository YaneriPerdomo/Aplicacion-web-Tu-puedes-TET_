                ...
                <div class="col-md-12 col-lg-7 ">
                    <div class="read">
                        <div class="etapa_uno_seccion_uno">
                                        ...
                                        <div class="styles_cuaderno" style="background-image: linear-gradient(45deg, rgb(255, 194, 1) 30%, rgb(252, 170, 1) 30% 50%, rgb(255, 193, 1) 50% 60%, rgb(252, 170, 1) 60% 65%, rgb(255, 194, 1) 55% 100%); filter: drop-shadow(2px 4px 0px rgb(212, 180, 1));">
                                            ...
                                            <div class="carita" style="text-align: center; color:white; ">
                                                <div>
                                                    ...
                                                    <span style="color:rgb(47, 47, 47); background: rgb(47, 47, 47,0.1); border-radius:0.4rem; padding: 0.2rem" >Lección Final</span>
                                                </div>
                                            </div>
                                        </div>
                                    </button>                                    
                            ...
                            <div class="d-flex justify-content-between  align-items-center" style="margin: 0rem 1rem;">
                                    <div>
                                    <div class=""><span class="fs-3">Etapa 1, Seccion 2</span><br> <span style="color:grey">Lecciones </span></div>
                                    </div>
                                    <div class="container-guia">
                                    <i class="bi bi-journal-text"></i><span>GUIA</span>
                                    </div>
                                        ...
                                        <div class="styles_cuaderno" style="background-image: linear-gradient(45deg, rgb(255, 194, 1) 30%, rgb(252, 170, 1) 30% 50%, rgb(255, 193, 1) 50% 60%, rgb(252, 170, 1) 60% 65%, rgb(255, 194, 1) 55% 100%); filter: drop-shadow(2px 4px 0px rgb(212, 180, 1));">
                                            ...
                                            <div class="carita" style="text-align: center; color:white; ">
                                                <div>
                                                    ...
                                                    <span style="color: rgb(47, 47, 47);background: rgb(47, 47, 47, 0.1); border-radius: 0.4rem; padding: 0.2rem;">Lección 4</span>
                                                </div>
                                            </div>
                                        </div>
                                    </button>
                                        ...
                                        <div class="styles_cuaderno" style="background-image: linear-gradient(45deg, rgb(255, 194, 1) 30%, rgb(252, 170, 1) 30% 50%, rgb(255, 193, 1) 50% 60%, rgb(252, 170, 1) 60% 65%, rgb(255, 194, 1) 55% 100%); filter: drop-shadow(2px 4px 0px rgb(212, 180, 1));">
                                            ...
                                            <div class="carita" style="text-align: center; color:white; ">
                                                <div>
                                                    ...
                                                    <span style="color: rgb(47, 47, 47);background: rgb(47, 47, 47, 0.1); border-radius: 0.4rem; padding: 0.2rem;">Lección 5</span>
                                                </div>
                                            </div>
                                        </div>
                                    </button>
