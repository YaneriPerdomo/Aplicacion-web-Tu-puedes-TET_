...
<body>
            ...
            <div class="container-xxl">
                <div class="tableContainer align-items-center justify-content-center" data-next="1">
                    <article>
                        ...
                        <section class="read">
                            <h3 class="title">
                                <i class="bi bi-volume-up me-1 repeatReading" style="cursor: pointer;"></i>
                                <em></em>
                            </h3>
                            <p></p>
                        </section>
                        <section class="questionAnswers">
                            <section class="questions" style="display: none;">
                                <hr>
                                <h4 class="mb-3 ">
                                    <i class="bi bi-volume-up me-1 repeatquestion" style="cursor: pointer;"></i>
                                    <em></em>
                                </h4>
                                <div class="d-flex flex-row justify-content-center  align-items-center"
                                    style="gap:1rem">
                                    <button><img src="" alt="" class="img-fluid" style="max-width: 134px; min-width: 70px;"></button>
                                    <button><img src="" alt="" class="img-fluid" style="max-width: 134px; min-width: 70px;"></button>
                                    <button><img src="" alt="" class="img-fluid" style="max-width: 134px; min-width: 70px;"></button>
                                </div>
                                <hr>
                            ...
                            <div class="containerNext">
                                <button class="nextLectura" data-next-lectura="0" data-view="1">Comenzar con las
                                    preguntas <i class="bi bi-caret-right"></i></button> 
                            </div>
                        </section>
                    </article>
                </div>
            ...
            <div class=" modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header modal-header--comenzar ">
                        <i class="bi bi-volume-up cuidado fs-5" style="cursor:pointer"></i>
    ...
    <script src="../../../../js/player/they_do_not_read/etapa_1_seccion_1/leccion_9.js" type="module"></script>
</body>
