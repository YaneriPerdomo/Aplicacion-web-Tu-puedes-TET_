...
<head>
    ...
    <title>Lección 5 | Tú puedes</title>
...
<body>
    <main>
        ...
        <div class="letterContainer">
            <div class="container-xxl">
                <div class="tableContainer" data-next="0" data-letter="fia">
                    <button>flu</button>
                    <button>flu</button>
                    <button>fla</button>
                    <button>gal</button>
    ...
    <script src="../../../../js/player/they_do_not_read/etapa_1_seccion_1/leccion_5.js"></script>
</body>
