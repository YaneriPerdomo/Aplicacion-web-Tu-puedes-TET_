...
<body style="background-image: url(../../../img/player/fondo.png);">
    ...
    <main>
         ...
         <h1 class="ms-2"> <i class="bi bi-volume-up preguntas_fs_audio me-0 fs-1 " style="font-size:1.1rem"></i>Preguntas Frecuentes:</h1>
        <div class="accordion accordion-flush" id="accordionFlushExample">
        <div class="accordion-item">
            <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                <i class="bi bi-volume-up pregunta_1_audio me-0 fs-4 " style="font-size:1.1rem"></i>¿Por qué no puedo editar mi perfil?
            </button>
            </h2>
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                <i class="bi bi-volume-up pregunta_2_audio me-0 fs-4 " style="font-size:1.1rem"></i>¿Cómo puedo ver mi progreso dentro de mi aprendizaje?
            </button>
            </h2>
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                <i class="bi bi-volume-up pregunta_3_audio me-0 fs-4 " style="font-size:1.1rem"></i>¿Qué es la tabla de calificación?
            </button>
            </h2>
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse_4" aria-expanded="false" aria-controls="flush-collapseTwo">
                <i class="bi bi-volume-up pregunta_4_audio me-0 fs-4 " style="font-size:1.1rem"></i>¿Cómo elimino mi usuario?
            </button>
            </h2>
    ...
    <script src="../../../js/player/help.js"></script>
</body>
</html>