                ...
                <div class="col-xl-10 col-lg-12">
                    <div class="mensaje_actualizacion" mensaje_actualizacion="show">
                        <div class="mensaje_actualizacion-body">
                            <strong class=" "> <i class="bi bi-volume-up mensaje__actualizacion--audio me-1 "
                                    style="font-size:1.1rem"></i>¿Notas algo... Diferente?</strong>
                    ...
                    <div class="read">
                        <div class="etapa_uno_seccion_uno">
                            <div class="d-flex justify-content-between  align-items-center "
                                ...
                                <div>
                                    <div class=""><span class="fs-3"> <i
                                                class="bi bi-volume-up etapaUnoSeccionUno_audio me-1 fs-3 "
                                                style="font-size:1.1rem"></i>Etapa 1, Seccion 1</span><br>
                            ...
                            <div class="container__styles_leccion">
                                <button type="button" class="btn " data-bs-toggle="modal"
                                    data-bs-target="#etapa_1_leccion_1">
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span><i class="bi bi-volume-up etapaUnoSeccionUnoL1_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 1</span>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                                ...
                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#no_acceso">
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                <div class="estado_juego">
                                                    <img src="../../../img/caritas/candado.png" style="width:2.5rem"
                                                        alt="">
                                                </div>
                                                <span><i class="bi bi-volume-up etapaUnoSeccionUnoL2_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 2</span>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span><i class="bi bi-volume-up etapaUnoSeccionUnoL3_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 3</span>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                            ...
                            <div class="container__styles_leccion">
                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#no_acceso">
                                    <div class="styles_cuaderno"
                                        style="background-image: linear-gradient(45deg, #ff4c92 30%, #e23b7c 30% 50%, #ff4c92 50% 60%, #e23b7c 60% 65%, #ff4c92 55% 100%); filter: drop-shadow(2px 4px 0px #c8366f);">
                                        <div class="black"
                                            style="position: absolute;width: 100%;height: 100%;background: rgb(47, 47, 47); width: 20px; height: 15px; top: 0.5rem; left: -0.5rem; border-radius: 0.5rem;">
                                        </div>
                                        <div class="black_dos"></div>
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span><i class="bi bi-volume-up etapaUnoSeccionUnoL4_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 4</span>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#no_acceso">
                                    <div class="styles_cuaderno"
                                        style="background-image: linear-gradient(45deg, #d55252 30%, #c64442 30% 50%, #d55252 50% 60%, #c64442 60% 65%, #d55252 55% 100%);
  filter: drop-shadow(2px 4px 0px #b73836);">
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span><i class="bi bi-volume-up etapaUnoSeccionUnoL5_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 5</span>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span> <i
                                                        class="bi bi-volume-up etapaUnoSeccionUnoL6_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 6</span>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span><i class="bi bi-volume-up etapaUnoSeccionUnoL7_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 7</span>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                                ...
                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#no_acceso">
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                <div class="estado_juego">
                                                    <img src="../../../img/caritas/Lightning.png"
                                                        style="width:2.5rem; height: 3rem;" alt="">
                                                </div>
                                                <span class=""
                                                    style="color:rgb(47, 47, 47); background: rgb(47, 47, 47,0.1); border-radius:0.4rem; padding: 0.2rem"><i
                                                        class="bi bi-volume-up etapaUnoSeccionUnoLFinal_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección Final</span>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                        ...
                        <div class="etapa_uno_seccion_dos">
                            <div class="d-flex justify-content-between  align-items-center" style="margin: 0rem 1rem;">
                                <div>
                                    <div class=""><span class="fs-3"><i
                                                class="bi bi-volume-up etapaUnoSeccionDos_audio me-1 fs-3 "
                                                style="font-size:1.1rem"></i>Etapa 1, Seccion 2</span><br> <span
                                    ...
                                    <div class="styles_cuaderno">
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span><i class="bi bi-volume-up etapaUnoSeccionDosL1_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 1</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span><i class="bi bi-volume-up etapaUnoSeccionDosL2_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 2</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span><i class="bi bi-volume-up etapaUnoSeccionDosL3_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 3</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span
                                                    style="color: rgb(47, 47, 47);background: rgb(47, 47, 47, 0.1); border-radius: 0.4rem; padding: 0.2rem;"><i
                                                        class="bi bi-volume-up etapaUnoSeccionDosL4_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 4</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span
                                                    style="color: rgb(47, 47, 47);background: rgb(47, 47, 47, 0.1); border-radius: 0.4rem; padding: 0.2rem;"><i
                                                        class="bi bi-volume-up etapaUnoSeccionDosL5_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección 5</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                ...
                                                <span
                                                    style="color:rgb(47, 47, 47); background: rgb(47, 47, 47,0.1); border-radius:0.4rem; padding: 0.2rem"><i
                                                        class="bi bi-volume-up etapaUnoSeccionDosLFinal_audio me-0 m-0 p-0  "
                                                        style="font-size:1.1rem"></i>Lección Final</span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-5  col-xl-3 text-center">
                    <div class="progreso_tabla">
                        <div class="progreso_usuario-flex">
                            <span class="fs-4 "><i class="bi bi-volume-up progreso_audio fs-4 me-1 m-0 p-0  "
                                    style="font-size:1.1rem"></i>Tu Progreso</span>
                            <div class="num_start">
                        ...
                        <div class="">
                            <a href="./progress.php" class="boton_revisar revisar_audio">
                                <img src="" alt="">
                                <span><i class="bi bi-bar-chart-line  me-1 m-0 p-0  "
                                        style="font-size:1.1rem"></i>REVISAR</span>
                            </a>
                        </div>
                    </div><br><br>
    ...
    <div class="modal fade " id="etapa_1_leccion_1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class=" modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="./etapa_1_seccion_1/leccion_1.php"><button type="button"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex  justify-content-evenly fs-5">
                        <i class="bi bi-volume-up voz_no_acceso me-2" style="font-size:2rem"></i>No podrás ingresar a
                        esta lección, hasta que hayas completado la anterior.
                    </div>
                </div>
                <div class="modal-footer text-center">
                    <button type="button" style="color: rgb(47, 47, 47);" class="btn btn-warning"
