...
<head>
    ...
    <title>Tu puedes | Progreso</title>
    ...
    <main>
        <div class="container-xxl w-100 h-100 mt-5" style="    background: white;border-radius: 0.5rem;padding: 1rem;border: 1px solid rgb(239, 239, 239);box-shadow: 0px 1px 2px rgb(215 215 215);">
            ...
            <div class="progreso_circulo">
                ...
                <div class="row">
                    <div class="col-6 mt-1">
                        ...
                        <div class="num_start ">
                            ...
                            <span class="fs-4"><strong>2</strong>
                                <e>Estrella(s)</e>
                            </span>
                        </div>
                    </div>
                ...
                <h2 class="fw-bold" style="color: var(--color-azul)"><i class="bi bi-volume-up progresoEtapaUnoAudio me-0 m-0 p-0 fs-2"></i>Etapa 1</h2>
                <p style="color:grey">
                ...
                <div class="row ">
                    <div class="col-6 mt-0">
                        <div>
                            ...
                            <div class="num_start ">
                                <i class="bi bi-star-fill fs-4 text-warning"></i>
                                <span class="fs-4"><strong>0</strong>
                                    <e>Estrella(s)</e>
                                </span>
                            </div>
                        </div>
                ...
                <h2 class="fw-bold" style="color: var(--color-azul)"><i class="bi bi-volume-up progresoEtapaDosAudio me-0 m-0 p-0 fs-2"></i>Etapa 2</h2>
                <p style="color:grey">
                <div class="d-flex align-items-center">
