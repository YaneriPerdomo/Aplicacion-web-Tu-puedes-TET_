...
async function countDownV() {
    ...
    $tableLetter.setAttribute("data-letter", "v")
    _1_3();
    voiceExercise("v");
    defineLetter("ʌ", "u", "v", Math.floor(Math.random() * 12));
    const CountdownNext = document.querySelector(".countDownNext");
    let countForNext = 60;
    let countdown = setInterval(() => {
        countForNext--;
...
async function countDownJ() {
    ...
    $progressBar.style.background = "#ff7d3f";
    $tableLetter.setAttribute("data-letter", "j")
    _1_3();
    voiceExercise("j");
    defineLetter("t", "ɾ̣", "j", Math.floor(Math.random() * 12));
    const CountdownNext = document.querySelector(".countDownNext");
    let countForNext = 60;
    let countdown = setInterval(() => {
        countForNext--;
...
async function CountDownW() {
    await $tableLetter.setAttribute("data-letter", "w")
...
async function nextV() {
    randomNumber = Math.floor(Math.random() * 12);
    await defineLetter("ʌ", "u", "v", randomNumber)
}
async function nextW() {
    randomNumber = Math.floor(Math.random() * 12);
    await defineLetter("ʍ", "m", "w", randomNumber)
}
async function nextJ() {
    randomNumber = Math.floor(Math.random() * 12);
    await defineLetter("t", "ɾ̣", "j", randomNumber)
}

async function nextP() {
    randomNumber = Math.floor(Math.random() * 12);
    await defineLetter("q", "b", "p",  randomNumber)
}
